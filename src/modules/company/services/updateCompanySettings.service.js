...
import { findCompanyByOwnerId, updateCompanySettings } from "../repositories/company.repository.js";
import CompanyDTO from "../dto/company.dto.js";

export const updateCompanySettingsService = async (ownerId, payload) => {
  if (!ownerId) {
  ...
  const updatedSettings = await updateCompanySettings(existingCompany.id, payload);

  return CompanyDTO.toSettingsResponse(updatedSettings);
};
